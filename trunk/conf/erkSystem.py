...
def doCommand(b, longHost, chan, command, params = ""):
    ...
    elif command == "owners" and replyto == nick and nick in b.owners:
        privMsg(b,replyto,"Owners: "+string.join(b.owners))
    elif command == "verify" and replyto == nick:
        if nick in b.owners:
    ...
    elif command == "unverify" and replyto == nick and nick in b.owners:
        b.owners.remove(nick)
